	...
	$output = '<form class="cookie-form mb-4" data-clear="'.$cookiereset.'">';
		$output .= '<div class="row">';
			$output .= '<div class="col-md-6 mb-0 d-flex">';
				$output .= '<div class="card cookies w-100"><label for="cookie_tool_level_0" class="card-body">';
			...
			$output .= '</div>';
			$output .= '<div class="col-md-6 mb-0 d-flex">';
				$output .= '<div class="card cookies w-100"><label for="cookie_tool_level_1" class="card-body">';
